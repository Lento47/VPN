...
class VPNClientGUI:
        ...
        try:
            ...
            with socket.create_connection((self.server_host.get(), self.server_port.get()), timeout=10) as sock:
                ...
                with context.wrap_socket(sock, server_hostname=self.server_host.get()) as self.secure_sock:
                    ...
                    self.master.after(0, self._update_gui_connected)
            ...
            self.master.after(0, self._update_gui_disconnected, "Error")
        finally:
            self.running = False
            self.master.after(0, self._update_gui_disconnected)
    ...
    def _update_gui_disconnected(self, status="Disconnected"):
